...
enum { HELP, CAF, WAV, AMB, AIFF, FLAC, BIT16, BIT24, FLOAT, REC, TRI, LIPS, GAIN, FROM, UPTO };
...
{
    fprintf (stderr, "\nmakemulti %s\n", VERSION);
    fprintf (stderr, "(C) 2009-2016 Fons Adriaensen  <fons@linuxaudio.org>\n");
...
int main (int ac, char *av [])
{
    ...
    if ((t_from >= 0) && (t_upto >= 0) && (t_upto < t_from + 0.001))
    {
